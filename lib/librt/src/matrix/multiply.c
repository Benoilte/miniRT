...
/*   Updated: 2024/08/12 11:03:06 by bgolding         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	return ((t_tuple){\
		dot_product_row_tuple(a.data[0], tuple),
		dot_product_row_tuple(a.data[1], tuple),
		dot_product_row_tuple(a.data[2], tuple),
		dot_product_row_tuple(a.data[3], tuple)});
}
